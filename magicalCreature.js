...
let creatureName = "SilverSpider"



// 2. Declare a variable named 'creatureDescription' and describe its magical properties as a string.
let creatureDescription = "SilverSpider is a magical creatures who eat bugs filled with mana"
...
let canVisit = "You may not visit SilverSpider because you are under the age listed";
...
// Declare a variable named 'zooSummary' and combine all the above information using concatenation.
 let zooSummary = "Welcome to the magical creature zoo! Our magical creature is " + creatureName + ". " + creatureDescription + ". " + "The age restriction is " + visitorAge + ". " + canVisit;
